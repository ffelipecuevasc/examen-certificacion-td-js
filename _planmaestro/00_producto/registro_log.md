...
| Estado | Iteración | Tarea |
|---|---|---|
| ⚪ | 21 | **El banco nuevo suma, no reemplaza: 405 preguntas.** Decisión del autor del 2026-09-04, tomada al comprobar que los dos bancos no se solapan en enunciados. Merece ADR propia —queda propuesta, sin escribir— porque condiciona el esquema, la carga y el simulacro |
