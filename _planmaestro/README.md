...
pie y vigilada por `verificar:copias`— y la **etapa C** —vigilancia del consumo, protecciones y `90-manual/`—, cerrada
el 2026-09-25. Sigue la D, que ejecuta el autor en producción.
